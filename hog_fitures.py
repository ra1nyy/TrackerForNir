...
class HOG_fitures:
    @jit
    def func1(self, dx, dy, boundary_x, boundary_y, height, width, numChannels):
    ...
    @jit
    def func2(self, dx, dy, boundary_x, boundary_y, r, alfa, nearest, w, k, height, width, sizeX, sizeY, p, stringSize):
    ...
    @jit
    def func3(self, partOfNorm, mappmap, sizeX, sizeY, p, xp, pp):
    ...
    @jit
    def func4(self, mappmap, p, sizeX, sizeY, pp, yp, xp, nx, ny):
    ...
    def getFeatureMaps(self, image, k, mapp):
        ...
        # 200x speedup
        r, alfa = self.func1(dx, dy, boundary_x, boundary_y, height, width, numChannels)  # with @jit
        # ~0.001s
        ...
        '''
        # 500x speedup
        mapp['map'] = self.func2(dx, dy, boundary_x, boundary_y, r, alfa, nearest, w, k, height, width, sizeX, sizeY, p, stringSize)  # with @jit
        # ~0.001s
    ...
    def normalizeAndTruncate(self, mapp, alfa):
        ...
        # 30x speedup
        newData = self.func3(partOfNorm, mapp['map'], sizeX, sizeY, p, xp, pp)  # with @jit
        ###
    ...
    def PCAFeatureMaps(self, mapp):
        ...
        # 190x speedup
        newData = self.func4(mapp['map'], p, sizeX, sizeY, pp, yp, xp, nx, ny)  # with @jit
        ###
